...
def main():
    ...
    ap.add_argument("--lidar_pose", default="/mnt/lboro_nas/personal/Zhipeng/digiforests/digiforests-rosbags-c1/raw/val/2023-03/exp11-c1/rosbags/frontier_2023-03-22-08-23-52_1/GT_poses.txt", help="LiDAR pose trajectory file: timestamp x y z qx qy qz qw")
    ap.add_argument("--cam_ts", default="/mnt/lboro_nas/personal/Zhipeng/digiforests/digiforests-rosbags-c1/raw/val/2023-03/exp11-c1/rosbags/frontier_2023-03-22-08-23-52_1/_alphasense_driver_ros_cam0_debayered_image_compressed_image_name_timestamps.txt", help="Camera timestamps file (timestamp per line or first column)")
    ap.add_argument("--output_name", default="GT_poses_algin_with_colmap_timestamp.txt", help="Output pose file aligned to camera timestamps")
